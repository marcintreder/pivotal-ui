  ...
  render() {
    ...
    return (
      <div
        {...{
          ...props,
          className: classnames('pui-panel-container', className)
        }}
      >
        {(title || titleCols.length > 0) && (
          <Grid className={classnames('pui-panel-title', titleClassName)}>
            {title && (
              <FlexCol
        ...
        <div
          {...{
            className: classnames(
              'pui-panel bg-neutral-11 box-shadow-1 border-rounded',
              panelClassName
            )
          }}
        >
          {(header || headerCols.length > 0) && (
            <Grid className={classnames('pui-panel-header', headerClassName)}>
              {header && (
                <FlexCol
                  contentAlignment="middle"
          ...
          {footer && (
            <div
              className={classnames(
                'pui-panel-footer type-ellipsis h6',
                footerClassName
              )}
            >
              {footer}
