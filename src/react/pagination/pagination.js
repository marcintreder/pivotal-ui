...
export class PaginationButton extends React.PureComponent {
  static propTypes = {
  ...
  render() {
    ...
    const buttonType = active ? 'brand' : 'default';
...
export default class Pagination extends React.PureComponent {
  ...
  render() {
    ...
    const prevButton = (
      <PaginationButton
        {...{
          ...
          onSelect,
          eventKey: 'prev',
          content: <Iconography src="chevron_left" />,
          iconOnly: true,
          activePage
        }}
      />
    ...
    const nextButton = (
      <PaginationButton
        {...{
          ...
          onSelect,
          eventKey: 'next',
          content: <Iconography src="chevron_right" />,
          iconOnly: true,
          activePage
        }}
      />
    ...
    return (
      <div className={classnames('pagination', className)} role="group">
