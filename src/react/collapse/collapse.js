...
export class BaseCollapse extends React.PureComponent {
  ...
  renderHeader() {
    ...
    return (
      <a href="#" aria-expanded={expanded} aria-selected={expanded}>
        {header}
      </a>
    );
  }
  ...
  render() {
    ...
    return (
      <div {...props}>
        <div
          className="pui-collapse-panel-heading panel-heading"
          onClick={this.handleSelect}
        >
          <div
            className="pui-collapse-panel-title panel-title"
            role="presentation"
          >
            {this.renderHeader()}
          </div>
        ...
        <div className="pui-collapse-panel panel-collapse">
          <Collapsible
            className="pui-collapse-panel-body panel-body"
            expanded={expanded}
            delay={200}
          >
            {children}
...
export class Collapse extends BaseCollapse {
  renderHeader() {
    ...
    return (
      <div className="pui-collapse-trigger collapse-trigger">
